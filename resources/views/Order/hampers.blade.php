...
<body>
    ...
    <legend class="text-center mb-5">Product Hampers</legend>
        ...
        <div class="card mb-5" style="width: 100%;">
            <div class="row g-0">
                <div class="col-md-4 d-flex justify-content-center">
                    <div class="card-header p-3" style="height: 400px; background: #CC9650">
                ...
                <div class="col-md-8">
                    <div class="card-body h-100 d-flex flex-column">
                        <div class="row">
                            <div class="col-md-7">
                                <h5 class="fw-bold text-start mb-1" style="color: #9D4B22; font-size: 45px;">{{ $item['nama'] }}</h5>
                            </div>
                            <div class="col-md-4">
                                <p class="text-end mb-0" style="font-size: 18px; margin-top: 10px;">Stock : {{ $item['stok'] }}</p>
                            </div>
                        </div>
                        <p class="card-text text-start mt-3" style="font-size: 20px;">{{ $item['deskripsi'] }}</p>
                        <h5 class="fw-bold text-start mb-0 mt-2" style="color: #9D4B22; font-size: 37px;">Rp {{ $item['harga'] }}</h5>
                        <div class="col-md-4 d-flex justify-content-start" style="margin-top: 5%;">
                        ...
                        <div class="mt-auto">
                            <a class="btn order-now-btn text-center w-100" href="{{ url('bayar') }}">Order Now</a>
                        </div>
                    </div>
                </div>
            </div>
