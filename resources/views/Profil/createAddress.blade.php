...
<body>
    ...
    <legend class="text-center">Create Address</legend>
    ...
    <div class="container p-5" style="background: #FFFCD3; box-shadow: 0 10px 10px 10px rgba(128, 128, 128, 0.2); margin-top: 12%">
        <form class="form" action="{{ url('address') }}">
            ...
            <div class="input-container mb-3 bg-transparent">
                ...
                <textarea type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Input Address..." style="border: 2px solid #CC9650; background: transparent; height: 200px;"></textarea>
                @error('nama')
            ...
            <div class="container-fluid search-container" style="margin-top: 10%;">
                <div class="row">
                    ...
                    <div class="col-md-1 d-flex justify-content-end align-items-end">
                        <button class="btn" type="submit" style="background: #9D4B22; color: #FFFCD3; width: 95px;">Add</button>
                    </div>
                </div>
            </div>
        </form>
